...
const NCJMM_STEPS = [
  {
    step: 1,
    name: "Recognize Cues",
    summary: "Pick out the relevant data from the case.",
  },
  {
    step: 2,
    name: "Analyze Cues",
    summary: "Decide what those data mean together.",
  },
  {
    step: 3,
    name: "Prioritize Hypotheses",
    summary: "Rank the most likely and most dangerous problems.",
  },
  {
    step: 4,
    name: "Generate Solutions",
    summary: "List the possible nursing actions.",
  },
  {
    step: 5,
    name: "Take Action",
    summary: "Choose and perform the highest-priority action.",
  },
  {
    step: 6,
    name: "Evaluate Outcomes",
    summary: "Check whether what you did is working.",
  },
];
    ...
    <main className="flex-1 px-4 py-8">
      <div className="max-w-3xl mx-auto">
        ...
        <p className="text-slate-600 mt-1 mb-8">
          Structural reference for how items are distributed on the exam
          (effective April 2026, per NCSBN). Use this to balance your practice
          across categories.
        </p>
        ...
        <section className="mb-10">
          ...
          <p className="text-xs text-slate-500 mt-2">
            Individual exams can differ ±3% per category. Clinical judgment is
            also tested explicitly through 18 case-study items (three item sets)
