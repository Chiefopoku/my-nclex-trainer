...
export const DEMO_STUDY_FACTS: DemoStudyFact[] = [
  // Golden rules
  { id: 'g1', category: 'Golden Rules', title: 'ABC priority', body: 'Airway before Breathing before Circulation.', tags: ['priority'] },
  { id: 'g2', category: 'Golden Rules', title: 'Maslow', body: 'Physical needs before emotional needs.', tags: ['priority'] },
  { id: 'g3', category: 'Golden Rules', title: 'Assess before act', body: 'When unsure: assess. In an emergency: act.', tags: ['priority'] },
  { id: 'g4', category: 'Golden Rules', title: 'Nurse before doctor', body: 'Do the nursing action first; call the provider when you have done all you can.', tags: ['priority'] },
  { id: 'g5', category: 'Golden Rules', title: 'Acute beats chronic', body: 'See the new or unstable patient first.', tags: ['priority'] },
  { id: 'g6', category: 'Golden Rules', title: 'Delegation', body: 'RN keeps assessment, teaching, evaluation, unstable patients, and any first.', tags: ['delegation'] },

  // NCJMM steps
  { id: 'n1', category: 'NCJMM', title: 'Step 1 — Recognize Cues', body: 'Notice the relevant data in the case (vitals, labs, symptoms).', tags: ['clinical-judgment'] },
  { id: 'n2', category: 'NCJMM', title: 'Step 2 — Analyze Cues', body: 'Decide what those data mean and how they relate.', tags: ['clinical-judgment'] },
  { id: 'n3', category: 'NCJMM', title: 'Step 3 — Prioritize Hypotheses', body: 'Rank what is most likely and most dangerous.', tags: ['clinical-judgment'] },
  { id: 'n4', category: 'NCJMM', title: 'Step 4 — Generate Solutions', body: 'List possible nursing actions.', tags: ['clinical-judgment'] },
  { id: 'n5', category: 'NCJMM', title: 'Step 5 — Take Action', body: 'Choose and perform the highest-priority action.', tags: ['clinical-judgment'] },
  { id: 'n6', category: 'NCJMM', title: 'Step 6 — Evaluate Outcomes', body: 'Decide whether what you did is working.', tags: ['clinical-judgment'] },

  // Lab values
  { id: 'l1', category: 'Lab Values', title: 'Potassium (K+)', body: 'Normal 3.5–5.0. The heart electrolyte — peaked T waves with high K, never IV push.', tags: ['cardiac', 'electrolyte'] },
  { id: 'l2', category: 'Lab Values', title: 'Sodium (Na+)', body: 'Normal 135–145. Low Na causes confusion, headache, seizures.', tags: ['electrolyte', 'neuro'] },
  { id: 'l3', category: 'Lab Values', title: 'Calcium', body: 'Normal 9–11. Low Ca: tetany, Chvostek and Trousseau signs.', tags: ['electrolyte'] },
  { id: 'l4', category: 'Lab Values', title: 'Magnesium', body: 'Normal 1.5–2.5. Antidote for Mg toxicity is calcium gluconate.', tags: ['electrolyte', 'OB'] },
  { id: 'l5', category: 'Lab Values', title: 'Fasting glucose', body: 'Normal 70–110. Treat hypoglycemia <70 fast with 15 g simple carbs.', tags: ['endocrine'] },
  { id: 'l6', category: 'Lab Values', title: 'Arterial pH', body: 'Normal 7.35–7.45. Below = acidosis, above = alkalosis.', tags: ['ABG'] },
  { id: 'l7', category: 'Lab Values', title: 'Hemoglobin', body: 'Normal 12–18. Low = anemia, fatigue, pallor.', tags: ['heme'] },
  { id: 'l8', category: 'Lab Values', title: 'Platelets', body: 'Normal 150k–400k. Below 150k = bleeding precautions.', tags: ['heme'] },
  { id: 'l9', category: 'Lab Values', title: 'WBC', body: 'Normal 5k–10k. Low = neutropenic precautions.', tags: ['heme', 'infection'] },
  { id: 'l10', category: 'Lab Values', title: 'INR (on warfarin)', body: 'Target 2–3. Above 4 = bleeding risk; hold warfarin.', tags: ['anticoag'] },
  { id: 'l11', category: 'Lab Values', title: 'BUN / Creatinine', body: 'BUN 10–20, Cr 0.6–1.2. Rising = kidney trouble.', tags: ['renal'] },
  { id: 'l12', category: 'Lab Values', title: 'Digoxin level', body: 'Therapeutic 0.5–2 ng/mL. Above 2 = toxicity.', tags: ['cardiac', 'drug-level'] },
  { id: 'l13', category: 'Lab Values', title: 'Lithium level', body: 'Therapeutic 0.6–1.2. Above 1.5 = toxicity (tremor, confusion).', tags: ['psych', 'drug-level'] },
  { id: 'l14', category: 'Lab Values', title: 'Phenytoin (Dilantin)', body: 'Therapeutic 10–20 mcg/mL.', tags: ['neuro', 'drug-level'] },

  // Antidotes
  { id: 'a1', category: 'Antidotes', title: 'Heparin', body: 'Antidote: protamine sulfate. Monitor aPTT.', tags: ['anticoag'] },
  { id: 'a2', category: 'Antidotes', title: 'Warfarin', body: 'Antidote: vitamin K. Monitor INR.', tags: ['anticoag'] },
  { id: 'a3', category: 'Antidotes', title: 'Acetaminophen', body: 'Antidote: N-acetylcysteine (Mucomyst).', tags: ['tox'] },
  { id: 'a4', category: 'Antidotes', title: 'Opioids', body: 'Antidote: naloxone (Narcan).', tags: ['respiratory', 'tox'] },
  { id: 'a5', category: 'Antidotes', title: 'Benzodiazepines', body: 'Antidote: flumazenil.', tags: ['tox'] },
  { id: 'a6', category: 'Antidotes', title: 'Magnesium sulfate', body: 'Antidote: calcium gluconate.', tags: ['OB'] },
  { id: 'a7', category: 'Antidotes', title: 'Digoxin', body: 'Antidote: digoxin immune Fab (Digibind).', tags: ['cardiac'] },
  { id: 'a8', category: 'Antidotes', title: 'Iron', body: 'Antidote: deferoxamine.', tags: ['tox'] },
  { id: 'a9', category: 'Antidotes', title: 'Insulin (low sugar)', body: 'Treat with dextrose IV or glucagon IM if no IV access.', tags: ['endocrine'] },
  { id: 'a10', category: 'Antidotes', title: 'Beta-blocker / CCB overdose', body: 'Glucagon for beta-blocker; calcium for CCB.', tags: ['cardiac', 'tox'] },

  // Positions
  { id: 'p1', category: 'Positions', title: 'Trouble breathing / heart failure', body: "High Fowler's — sit upright.", tags: ['respiratory', 'cardiac'] },
  { id: 'p2', category: 'Positions', title: 'Shock / low BP', body: 'Flat with legs elevated.', tags: ['shock'] },
  { id: 'p3', category: 'Positions', title: 'After lumbar puncture', body: 'Lie flat to prevent spinal headache.', tags: ['neuro'] },
  { id: 'p4', category: 'Positions', title: 'Increased ICP', body: 'HOB up 30 degrees, head midline.', tags: ['neuro'] },
  { id: 'p5', category: 'Positions', title: 'Post-tonsillectomy / unconscious', body: 'Side-lying to keep airway clear.', tags: ['airway'] },
  { id: 'p6', category: 'Positions', title: 'Air embolism / central line', body: 'Left side, head down (Trendelenburg).', tags: ['emergency'] },
  { id: 'p7', category: 'Positions', title: 'After liver biopsy', body: 'Right side-lying to apply pressure to the site.', tags: ['GI'] },
  { id: 'p8', category: 'Positions', title: 'Pregnant with low BP', body: 'Left side — relieves the vena cava.', tags: ['OB'] },
  { id: 'p9', category: 'Positions', title: 'Autonomic dysreflexia', body: 'Sit the client up immediately.', tags: ['neuro', 'emergency'] },

  // Isolation
  { id: 'i1', category: 'Isolation', title: 'Airborne (MTV)', body: 'Measles, TB, Varicella → negative-pressure room + N95.', tags: ['infection'] },
  { id: 'i2', category: 'Isolation', title: 'Droplet', body: 'Flu, pertussis, meningitis, mumps, rubella → mask within 3 ft.', tags: ['infection'] },
  { id: 'i3', category: 'Isolation', title: 'Contact', body: 'MRSA, VRE, C. diff, RSV, scabies → gown + gloves.', tags: ['infection'] },
  { id: 'i4', category: 'Isolation', title: 'C. difficile', body: 'Soap and water — alcohol gel does not kill spores.', tags: ['infection'] },
  { id: 'i5', category: 'Isolation', title: 'Neutropenic precautions', body: 'Protect the patient: no fresh flowers, no raw produce, no sick visitors.', tags: ['infection', 'heme'] },

  // Communication
  { id: 'c1', category: 'Communication', title: 'Open-ended response', body: 'Try: "Tell me more about that."', tags: ['psych'] },
  { id: 'c2', category: 'Communication', title: 'Reflect feelings', body: "Try: \"You're feeling overwhelmed.\"", tags: ['psych'] },
  { id: 'c3', category: 'Communication', title: 'Silence is therapy', body: 'Sitting in silence gives the client space.', tags: ['psych'] },
  { id: 'c4', category: 'Communication', title: 'Avoid false reassurance', body: 'Skip "Everything will be fine."', tags: ['psych'] },
  { id: 'c5', category: 'Communication', title: 'Avoid "why" questions', body: 'They feel accusing.', tags: ['psych'] },
];
...
export const DEMO_QUESTIONS: DemoQuestion[] = [
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'C', text: 'This is impending respiratory failure; airways are closing' },
      { id: 'D', text: 'This is a normal finding after multiple inhaler doses' },
    ],
  ...
  },
  {
    ...
    scenario: {
      ...
      vitals: { BP: '104/62', HR: 124, RR: 30, SpO2: '99% on RA', Temp: '99.4 F' },
      labs: {
        Glucose: '512 mg/dL',
        pH: '7.21',
        HCO3: '12 mEq/L',
